...
<head>
  ...
  />
  <title>Welcome Bid Library</title>
      ...
      <div class="panel-body">
        <figure class="logo animated fadeInDown delay-07s">
          <a href="https://atos.net/en">
            <img src="https://atos.net/wp-content/themes/atos/images/atos-logo-menu-bar.png" alt="">
          </a>
        </figure>
        <h1 class="animated fadeInDown delay-07s">Bid Library</h1>
